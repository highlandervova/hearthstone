...
public class UsWaitBattService {
    ...
    public String addPrepareForBattle( User user1, User user2) {
        ...
        Battle battle1 = new Battle(idBattle, user1.getId(),user1.getLogin(), user1.getName(), user1.getRaceid(), 0, user1.getPoints(), user1.getMoney(), user1.getGold(), null, user1.getDeck(), null);
         usBattle.add(battle1);
        Battle battle2 = new Battle(idBattle, user2.getId(),user2.getLogin(), user2.getName(), user2.getRaceid(), 0, user2.getPoints(), user2.getMoney(), user2.getGold(), null, user2.getDeck(), null);
        usBattle.add(battle2);
